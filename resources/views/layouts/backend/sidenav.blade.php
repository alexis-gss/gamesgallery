            ...
            <div class="accordion" id="accordionHome">
                <div class="accordion-item mb-1">
                    <div class="accordion-body">
                        ...
                        @can('isAdmin')
                            <a class="nav-link py-0 px-0 mx-4" title="{{ __('sidenav.title_create_game') }}"
                                href="{{ route('bo.games.create') }}">{{ __('sidenav.add_game') }}</a>
                        @endcan
                        <a class="nav-link py-0 px-0 mx-4 pb-1 mb-1 border-bottom"
                            title="{{ __('sidenav.title_list_games') }}"
                            href="{{ route('bo.games.index') }}">{{ __('sidenav.list_games') }}</a>
                        @can('isAdmin')
                            <a class="nav-link py-0 px-0 mx-4" title="{{ __('sidenav.title_create_folder') }}"
                                href="{{ route('bo.folders.create') }}">{{ __('sidenav.add_folder') }}</a>
                        @endcan
                        <a class="nav-link py-0 px-0 mx-4" title="{{ __('sidenav.title_list_folders') }}"
