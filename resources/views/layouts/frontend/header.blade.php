<header>
    ...
    <section class="btns">
        <button class="btn_theme" title="{{ __('nav.btn_theme') }}">
            <svg class="theme_light" viewBox="0 0 16 16">
                <path
            ...
            <svg class="theme_dark" viewBox="0 0 16 16">
                <path
        ...
        <button class="btn_connect" title="{{ __('nav.btn_connect') }}">
            <a href="{{ route('bo.') }}" target="_blank">
                <svg viewBox="2 2 12 12">
                    <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                </svg>
            </a>
        </button>
        <button class="btn_github" title="{{ __('nav.btn_github') }}">
