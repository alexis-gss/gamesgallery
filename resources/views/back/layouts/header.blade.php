                ...
                @auth
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end text-center p-0" aria-labelledby="navbarDropdown">
                            <a class="btn btn-link w-100 h-100 text-decoration-none text-muted p-2" href="{{ route('bo.users.edit', Auth::user()->id) }}"
                                title="{{ __('header.to_edit_profile') }}" data-bs="tooltip" data-bs-placement="bottom">{{ __('header.edit_profile') }}</a>
