            ...
            <div class="row mb-3">
                <div class="col-12 col-md-6 form-group">
                    <label for="name" class="col-form-label">
                        ...
                        <svg data-bs="tooltip" data-bs-placement="top" title="{{ __('form.tooltip_name_folder') }}" width="16" height="16" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
